//-----------------------------------------------------------------------
// <copyright file="FlowAnalysisContext.cs">
...
namespace Microsoft.CodeAnalysis.CSharp.DataFlowAnalysis
{
    ...
    /// </summary>
    public sealed class FlowAnalysisContext
    {
        #region fields
        ...
        private FlowAnalysisContext(Project project)
        {
        ...
        public static FlowAnalysisContext Create(Project project)
        {
            return new FlowAnalysisContext(project);
        }
